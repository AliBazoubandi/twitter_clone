...
const tweetController = {
  ...
  deleteTweet: async (req, res) => {
    ...
    try {
        ...
        // Remove retweets
        const retweetUserIds = tweet.retweets.map(retweet => retweet.toString());
        await User.updateMany({ _id: { $in: retweetUserIds } }, { $pull: { retweets: tweetId } });
  ...
  likeTweet: async (req, res) => {
    ...
    try {
      ...
      const hasLiked = tweet.likes.some((like) => like.user.toString() === userId);
